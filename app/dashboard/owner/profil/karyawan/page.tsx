        ...
        <div className="p-8 w-full">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="relative">
                    ...
                    <input type="text" placeholder="Cari karyawan..." className="pl-10 pr-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" />
                </div>
            </div>
                        ...
                        {[...Array(3)].map((_, i) => (
                            <tr key={i} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                <td className="px-6 py-4 flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold">{String.fromCharCode(65 + i)}</div>
                                    <div>
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg mr-2" title="Lihat Profil"><Eye className="w-4 h-4" /></button>
